...
void VerifyHotDogs(const std::vector<HotDog>& hotdogs) {
    std::osyncstream(std::cout) << "VERIFY" << std::endl;
    ...
    for (auto& hotdog : hotdogs) {
        ...
        {
            std::osyncstream(std::cout) << "Hotdog ID: " << hotdog.GetId() 
                                        << " Sausage ID: " << hotdog.GetSausage().GetId() 
                                        << " Sausage ID: " << hotdog.GetBread().GetId() << std::endl;
